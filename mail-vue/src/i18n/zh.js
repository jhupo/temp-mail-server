const zh = {
    ...
    oss: '对象存储',
    osDomain: '对象访问域名',
    ossDomainDesc: '用于生成对象存储中文件、背景图、附件的访问链接，和邮箱收发域名无关；当前使用 Postgres 存储时可留空',
    emailPush: '邮件推送',
    tgBot: 'Telegram 机器人',
    disable: '关闭',
    disabled: '已关闭',
    ...
    updateNotConfigured: '未配置更新 Webhook',
    updateConfirm: '确认触发服务器更新吗？',
    ...
    allDomainsAllowed: '留空即允许所有已解析到服务器的域名',
