const en = {
    ...
    oss: 'Object Storage',
    osDomain: 'Object Access Domain',
    ossDomainDesc: 'Used to build public URLs for object-storage files, backgrounds, and attachments. It is unrelated to mail receive domains and can stay empty when using Postgres storage.',
    ...
    checkUpdate: 'Refresh',
    clickUpdate: 'Update Now',
    updateCheckFailed: 'Failed to check update',
    updateNotConfigured: 'Update webhook is not configured',
    updateConfirm: 'Trigger server update now?',
    updateQueued: 'Update job queued',
    community: 'Community',
    ...
    allDomainsAllowed: 'Empty means allow any domain that points to this server',
